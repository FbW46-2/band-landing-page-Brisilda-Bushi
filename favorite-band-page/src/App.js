  ...
  return (
    <Router>
      ...
      <div className="Navbar">
        <NavLink activeClassName="is-active" activeStyle={{color:"white"}} to="/vocals">Vocals</NavLink> 
        <NavLink activeClassName="is-active" activeStyle={{color:"white"}} to="/guitar">Guitar</NavLink>
        <NavLink activeClassName="is-active" activeStyle={{color:"white"}} to="/bass">Bass</NavLink> 
        <NavLink activeClassName="is-active" activeStyle={{color:"white"}} to="/drums">Drums</NavLink>
      </div>
      <Content />
    </Router>
  );
